...
--
-- Servidor: localhost
-- Tiempo de generación: 28-01-2022 a las 03:08:41
...
(2, 'Yaimel', 'Gonzalez', 'Leyva', 'Cubana', 'El Loco');
...
INSERT INTO `cds` (`id`, `numero`, `descripcion`) VALUES
(2, 5, 'Padre Perico');
...
(2, 'Literatura', 'Francesa', 'Poema', 'c685'),
(3, 'Literatura', 'Francesa', 'Canción', 'mx826');
...
--
-- Volcado de datos para la tabla `karde`
--

INSERT INTO `karde` (`id`, `nombre`, `numero_karde`) VALUES
(1, 'Somos Jóvenes', 8),
(4, 'Bohemia', 6),
(7, 'Verde Olivo', 7),
(8, 'Bohemia Cubana', 12),
...
INSERT INTO `libros` (`id`, `referencia`, `titulo`, `id_autor`, `imagen`, `anio_pub`, `id_editorial`, `lugar_pub`, `cantidad_ejemplares`, `id_clasificacion`, `doi`, `isbn`) VALUES
(5, '833<br>Y<br>Gon', 'El Mundo Rojo', 2, '', 2022, 1, 'La Habana', 3, 1, '', '');
...
INSERT INTO `materias` (`id`, `materia`, `descripcion`) VALUES
...
INSERT INTO `periodicos` (`id`, `id_editorial`, `dia`, `mes`, `anio`, `descripcion`) VALUES
(1, 1, 1, 1, 2022, 'sdf'),
(2, 2, 6, 11, 1906, 'HOla Mundo');
...
INSERT INTO `revistas` (`id`, `id_karde`, `numero`, `anio`, `descripcion`) VALUES
(1, 1, 15, 1998, 'Toda Cool');
...
--
-- Volcado de datos para la tabla `tabloides`
--

INSERT INTO `tabloides` (`id`, `titulo`, `numero`) VALUES
(1, 'El Mundo Rojo', 5);
